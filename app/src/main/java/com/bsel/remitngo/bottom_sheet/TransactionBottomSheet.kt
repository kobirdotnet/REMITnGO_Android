        ...
        transactionViewModel.transactionDetailsResult.observe(this) { result ->
            if (result!!.data != null) {
                for (transactionDetailsData in result!!.data!!) {
                    ...
                    val sendAmount = transactionDetailsData!!.benAmount.toString()
                    binding.benAmount.text = "BDT $sendAmount"
                    ...
                    binding.paymentStatus.text = transactionDetailsData!!.status.toString()
                    binding.transactionStatus.text = transactionDetailsData!!.transactionStatus.toString()
                }
                Log.i("info", "get transaction details successful: $result")
            } else {
                Log.i("info", "get transaction details failed")
            }
        }
    }
