...
import com.bsel.remitngo.databinding.PayingAgentCashPickupBankNameLayoutBinding
...
class PayingAgentCashPickupBottomSheet : BottomSheetDialogFragment() {
    ...
    private lateinit var binding: PayingAgentCashPickupBankNameLayoutBinding
    ...
    override fun onCreateDialog(savedInstanceState: Bundle?): Dialog {
        ...
        val view = View.inflate(requireContext(), R.layout.paying_agent_cash_pickup_bank_name_layout, null)
